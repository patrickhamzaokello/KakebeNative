...
public class ViewAddressesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ViewAddressesAdapter(Context context, SelectedAddressListener callback) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.viewaddresslayout, parent, false);
