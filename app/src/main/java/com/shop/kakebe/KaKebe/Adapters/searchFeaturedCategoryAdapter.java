...
public class searchFeaturedCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public searchFeaturedCategoryAdapter(Context context) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.search_featured_category_item_design, parent, false);
