...
public class ViewDeliveryAddress extends AppCompatActivity implements SelectedAddressListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("My Addresses ");
        ...
        User user = SharedPrefManager.getInstance(ViewDeliveryAddress.this).getUser();
        userId = user.getId();
        ...
        shopApiEndPoints = ShopAPIBase.getClient(ViewDeliveryAddress.this).create(ShopApiEndPoints.class);
    ...
    private void createNewAddress() {
        Intent intent = new Intent(ViewDeliveryAddress.this, CreateAddress.class);
...
//                Log.i(TAG, "onResponse: " + (response.raw().cacheResponse() != null ? "Cache" : "Network"));
    ...
    private void showCategoryErrorView() {
        ...
        AlertDialog.Builder android = new AlertDialog.Builder(ViewDeliveryAddress.this);
        ...
        android.setMessage("There has been an error.")
                ...
                .setPositiveButton("Home", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //go to activity
                        Intent intent = new Intent(ViewDeliveryAddress.this, RootActivity.class);
