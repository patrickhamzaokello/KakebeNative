...
public class SelectOrderAddressesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SelectOrderAddressesAdapter(Context context, SelectedAddressListener callback) {
