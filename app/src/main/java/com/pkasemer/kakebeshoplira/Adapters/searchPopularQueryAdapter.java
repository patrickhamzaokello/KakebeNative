...
import com.pkasemer.kakebeshoplira.Utils.SearchPopularTagAdapterCallBack;
...
public class searchPopularQueryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    private final SearchPopularTagAdapterCallBack mCallback;
    ...
    public searchPopularQueryAdapter(Context context, SearchPopularTagAdapterCallBack callback) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                movieVH.searchtag.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        //send the tag to SearchHomeJavaAdapter
                        mCallback.searchpopulartag(popularSearch.getQuery());
                    }
                });
...
//                Do nothing
    ...
    */
    ...
    protected class MovieVH extends RecyclerView.ViewHolder {
        ...
        private final MaterialCardView searchtag;
